...
public class Mail {
     ...
     */
    public Mail(String smtpServer, String from, String displayName, String username, String password, ArrayList<String> toList, String subject, String content) {
        this.smtpServer = smtpServer;
        this.from = from;
        this.displayName = displayName;
        this.ifAuth = true;
     ...
     */
    public Mail(String smtpServer, String from, String displayName, ArrayList<String> toList, String subject, String content) {
        this.smtpServer = smtpServer;
        this.from = from;
        this.displayName = displayName;
        this.ifAuth = false;
